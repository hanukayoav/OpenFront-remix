...
const miniBigSmoke = "/sprites/bigsmoke.png";
const buildingExplosion = "/sprites/buildingExplosion.png";
const conquestSword = "/sprites/conquestSword.png";
const dust = "/sprites/dust.png";
const miniExplosion = "/sprites/miniExplosion.png";
const miniFire = "/sprites/minifire.png";
const nuke = "/sprites/nukeExplosion.png";
const SAMExplosion = "/sprites/samExplosion.png";
const sinkingShip = "/sprites/sinkingShip.png";
const miniSmoke = "/sprites/smoke.png";
const miniSmokeAndFire = "/sprites/smokeAndFire.png";
const unitExplosion = "/sprites/unitExplosion.png";
